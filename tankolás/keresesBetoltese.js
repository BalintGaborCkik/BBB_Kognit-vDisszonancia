...
function kozteVan(akt,min,max) {
    const aktDay = akt.year*365+monthTable[akt.month]+akt.day
    const minDay = min.year*365+monthTable[min.month]+min.day
    const maxDay = max.year*365+monthTable[max.month]+max.day
